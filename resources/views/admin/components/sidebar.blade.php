<div class="fixed inset-y-0 left-0 w-16 bg-bgSecondary border-r border-secondary flex flex-col items-center py-6 z-10">
    <div class="flex flex-col items-center space-y-4">
        ...
        <!-- Dashboard Icon -->
        <a href="{{ route('admin.dashboard') }}" class="sidebar-icon {{ request()->routeIs('admin.dashboard') ? 'active-link' : '' }}">
            <i class="fas fa-chart-pie"></i>
            <span class="sidebar-tooltip group-hover:scale-100">Dashboard</span>
        </a>
        
        <!-- Roles Icon -->
        <a href="{{ route('admin.roles.index') }}" class="sidebar-icon {{ request()->routeIs('admin.roles.*') ? 'active-link' : '' }}">
            <i class="fas fa-user-shield"></i>
            <span class="sidebar-tooltip group-hover:scale-100">Roles</span>
        </a>
        
        <!-- Permissions Icon -->
        <a href="{{ route('admin.permissions.index') }}" class="sidebar-icon {{ request()->routeIs('admin.permissions.*') ? 'active-link' : '' }}">
    ...
    <div class="mt-auto">
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="sidebar-icon text-red-500">
