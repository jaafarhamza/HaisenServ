...
@section('content')
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold text-textHeading">Edit Service: {{ $service->title }}</h1>
            <div class="space-x-2">
            ...
            <form action="{{ route('admin.services.update', $service) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="form-group">
                            <label for="description"
                                class="block text-sm font-medium text-textParagraph mb-1">Description*</label>
                            <textarea name="description" id="description" rows="6"
                                class="input-field w-full @error('description') border-red-500 @enderror" required>{{ old('description', $service->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-group">
                                <label for="price"
                                    class="block text-sm font-medium text-textParagraph mb-1">Price*</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="city" id="city" value="{{ old('city', $service->city) }}" 
                            ...
                            <div class="form-group">
                                <label for="status"
                                    class="block text-sm font-medium text-textParagraph mb-1">Status*</label>
                                <select name="status" id="status"
                                    class="input-field w-full @error('status') border-red-500 @enderror" required>
                                    @foreach ($statuses as $key => $value)
                                        <option value="{{ $key }}"
                                            @if (old('status', $service->status) == $key) selected @endif>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-group">
                                <label for="category_id"
                                    class="block text-sm font-medium text-textParagraph mb-1">Category*</label>
                                <select name="category_id" id="category_id"
                                    class="input-field w-full @error('category_id') border-red-500 @enderror" required>
                            ...
                            <div class="form-group">
                                <label for="user_id"
                                    class="block text-sm font-medium text-textParagraph mb-1">Provider*</label>
                                <select name="user_id" id="user_id"
                                    class="input-field w-full @error('user_id') border-red-500 @enderror" required>
                                    <option value="">Select Provider</option>
                                    <!-- You'll need to fetch providers from the database -->
                                    @if ($service->user)
                                        <option value="{{ $service->user_id }}" selected>{{ $service->user->name }}
                                        </option>
                                    @endif
                                </select>
                                @error('user_id')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="form-group">
                            <label for="meta_title" class="block text-sm font-medium text-textParagraph mb-1">Meta
                                Title</label>
                        ...
                        <div class="form-group">
                            <label for="meta_description" class="block text-sm font-medium text-textParagraph mb-1">Meta
                                Description</label>
                            <textarea name="meta_description" id="meta_description" rows="3"
                                class="input-field w-full @error('meta_description') border-red-500 @enderror">{{ old('meta_description', $service->meta_description) }}</textarea>
                        ...
                        <div class="form-group">
                            <label for="meta_keywords" class="block text-sm font-medium text-textParagraph mb-1">Meta
                                Keywords</label>
                        ...
                        <div class="form-group">
                            <label for="canonical_url" class="block text-sm font-medium text-textParagraph mb-1">Canonical
                                URL</label>
                        ...
                        <div class="form-group">
                            <label for="og_title" class="block text-sm font-medium text-textParagraph mb-1">OG
                                Title</label>
                        ...
                        <div class="form-group">
                            <label for="og_description" class="block text-sm font-medium text-textParagraph mb-1">OG
                                Description</label>
                            <textarea name="og_description" id="og_description" rows="3"
                                class="input-field w-full @error('og_description') border-red-500 @enderror">{{ old('og_description', $service->og_description) }}</textarea>
                        ...
                        <div class="form-group">
                            <label for="og_image_url" class="block text-sm font-medium text-textParagraph mb-1">OG Image
                                URL</label>
                            <input type="text" name="og_image_url" id="og_image_url"
                                value="{{ old('og_image_url', $service->og_image_url) }}"
                ...
                <div class="mt-6 flex justify-end">
                    <a href="{{ route('admin.services.index') }}" class="btn-secondary mr-2">
