...
<head>
    ...
    <style type="text/tailwindcss">
        @layer utilities {
            .sidebar-icon {
                @apply relative flex items-center justify-center h-12 w-12 mt-2 mb-2 mx-auto shadow-lg bg-bgSecondary text-textParagraph hover:bg-highlight hover:text-white rounded-3xl hover:rounded-xl transition-all duration-300 ease-linear;
            }

            .sidebar-tooltip {
                @apply absolute w-auto p-2 m-2 min-w-max left-14 rounded-md shadow-md text-white bg-bgSecondary text-xs font-bold transition-all duration-100 scale-0 origin-left;
            }
        ...
        .modal-content {
            background-color: var(--bg-secondary, #242629);
